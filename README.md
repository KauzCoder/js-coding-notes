...
Aprender e revisar os principais conceitos do JavaScript moderno (ES6+), aplicando **boas práticas** e exemplos comentados.  
O foco é **entender o funcionamento real do código**, não apenas decorar a sintaxe.
...
|-------|--------------------|------------|--------|
| [01 - Conceitos Básicos](01-conceitos-basicos/) | ![Fácil](https://img.shields.io/badge/Dificuldade-Fácil-brightgreen) | 0 | 🔴 Não iniciado |
